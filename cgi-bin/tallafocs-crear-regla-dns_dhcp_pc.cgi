...
<head>
<meta charset="UTF-8">
<title>Tallafocs INPUT DNS DHCP PORTAL CAPTIU</title>
...
<h1>Tallafocs INPUT DNS DHCP PORTAL CAPTIU</h1>
EOF
...
if [ -f "$FITXER" ]; then
	...
	<input type=\"hidden\" name=\"accio\" value=\"eliminar_regla_dns_dhcp_pc\">
	<input type=\"hidden\" name=\"posicio\" value=\"$N\">
    <input type="hidden" name="retorn" value="tallafocs-crear-regla-dns_dhcp_pc.cgi">
...
<form method="get" action="tallafocs-afegir-regla-dns_dhcp_pc.cgi">
<input type="hidden" name="retorn" value="tallafocs-crear-regla-dns_dhcp_pc.cgi">
<table>
