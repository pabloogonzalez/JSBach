...
RESULTAT=$("$DIR"/"$PROJECTE"/"$DIR_SCRIPTS"/client_srv_cli dmz configurar afegir "$PORT" "$PROTO" "$IP_DMZ")
...
<div class="container">
    <div class="card">
        <div class="card-header">
            <h2 class="card-title">Afegir Servei DMZ</h2>
        </div>
        <div class="card-body">
            <div class="alert" style="background: #e0f2f1; color: #00796b; padding: 16px; border-radius: 4px; margin-bottom: 24px;">
                <h3 style="margin-top: 0; margin-bottom: 8px;">Afegint Port \$PORT (\$PROTO) cap a la IP \$IP_DMZ</h3>
